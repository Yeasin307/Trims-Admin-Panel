...
const EditCategory = ({ editOpen, setEditOpen, active, setActive, categories, category }) => {
    ...
    const handleActive = async (e, categoryId, userId) => {
        if (e.target.value === "0") {
            ...
            if (proceed) {
                await axios.put("https://server.trimtex-bd.com/categories/activate-deactivate", { categoryId, userId, activateDeactivate: e.target.value }, {
                            ...
                            if (values?.image?.length === 0) {
                                ...
                                if (category?.name === values.name) {
                                    ...
                                    if (checkCycle) {
                                        ...
                                        await axios.put("https://server.trimtex-bd.com/categories/update-without-image", { values, categoryId, userId }, {
                                            headers: { Authorization: `Bearer ${localStorage.getItem("access_token")}` }
                                        })
                                            .then(() => {
                                ...
                                if (category?.name === values.name) {
                                    ...
                                    if (checkCycle) {
                                        ...
                                        await axios.put("https://server.trimtex-bd.com/categories/update-with-image", formData, {
                                            headers: { Authorization: `Bearer ${localStorage.getItem("access_token")}` }
                                        })
                                            .then(() => {
                                                actions.setSubmitting(false);
                                                                ...
                                                                <Box style={{ textAlign: 'start' }}>
                                                                    ...
                                                                    <Box>
                                                                        {imageList.length > 0 ?
                                                                            ...
                                                                            <Box >
                                                                                <img
                                                                                    src={`https://server.trimtex-bd.com/static/categoryimages/${category?.image}`}
                                                                                    alt=""
                                                                                    width="100"
                                                                                    height="75" />
                                                                            </Box>
